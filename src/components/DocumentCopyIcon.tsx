// src/components/DocumentCopyIcon.tsx
import React from 'react';

const DocumentCopyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg 
        version="1.1" // Ditambahkan: Harus ada di SVG lama
        id="Capa_1" // Ditambahkan: Untuk referensi internal
        xmlns="http://www.w3.org/2000/svg" // Ditambahkan
        xmlnsXlink="http://www.w3.org/1999/xlink" // Ditambahkan
        x="0px" y="0px"
        viewBox="0 0 699.428 699.428" // Ditambahkan: Ini kunci ukuran dan scaling
        xmlSpace="preserve"
        {...props}
    >
        <g>
            <g id="_x33__21_">
                <g>
                    {/* Menggunakan fill="currentColor" agar warna mengikuti text-class dari Tailwind */}
                    <path fill="currentColor" d="M502.714,0c-2.71,0-262.286,0-262.286,0C194.178,0,153,42.425,153,87.429l-25.267,0.59
                        c-46.228,0-84.019,41.834-84.019,86.838V612c0,45.004,41.179,87.428,87.429,67.428H459c46.249,0,87.428-42.424,87.428-87.428
